...
// Desactivar advertencias de librería externa
#if defined(_MSC_VER)
#pragma warning (push)
...
public:
    ...
    // Función futura para cargar modelos .json reales entrenados en Python
...
private:
    ...
    // Esta topología es estándar en plugins como NAM para modelar amplis limpios y crunch.
