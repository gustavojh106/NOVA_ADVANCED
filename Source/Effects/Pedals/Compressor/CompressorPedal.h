...
// ============================================================================
//  Studio Compressor — soft-knee, linked stereo, parallel blend
//  Reference: SSL bus comp transparency, Keeley Compressor+ sustain
// ============================================================================
...
public:
    ...
    void processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer&) override
    {
        ...
        for (int sample = 0; sample < numSamples; ++sample)
        {
            ...
            blockPeakGR = juce::jmax(blockPeakGR, reductionDb);

            // Parallel blend (linear — industry standard for parallel compression)
            for (int ch = 0; ch < numChannels; ++ch)
            {
        ...
        currentGainReductionDb = blockPeakGR;
    ...
    float currentGainReductionDb = 0.0f;  // Peak GR per block, for editor metering

    // Static curve computation exposed for editor visualization
